...
import com.zhe.funny.adapter.MainFragmentAdapter;
import com.zhe.funny.mvp.MainContract;
import com.zhe.funny.mvp.MainPresenter;
import com.zhe.funny.test.TestDataManager;

import java.util.ArrayList;
import java.util.List;

public class PageItemMainFragment extends SwipeRefreshFragment implements MainContract.View {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPresenter = new MainPresenter(new TestDataManager(), mActivity);
